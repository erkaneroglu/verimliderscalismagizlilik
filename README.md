Erkan Eroğlu, Verimli Ders Çalışma Teknikleri uygulamasını Ücretsiz bir uygulama olarak oluşturdu. Bu HİZMET, Erkan Eroğlu tarafından ücretsiz olarak sağlanmaktadır ve olduğu gibi kullanılması amaçlanmıştır.
...
Bu Gizlilik Politikasında kullanılan terimler, bu Gizlilik Politikasında aksi belirtilmedikçe Verimli Ders Çalışma Teknikleri adresinden erişilebilen Hüküm ve Koşullarımızdaki anlamlara sahiptir.
